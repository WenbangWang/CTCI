...
public class LinkedList_0<T> implements Iterable<T> {
  ...
  public LinkedList_0(Node<T> first) {
    this.first = first;
    count = 0;
    Node<T> node = first;
...
//		first.next = null;
  ...
  protected void insertLast(T key) {
...
//		last.next = null;
  ...
  private class LinkedListIterator<TT> implements Iterator<TT> {
    ...
    private LinkedList_0<TT> list;
    private int current = -1;

    public LinkedListIterator(LinkedList_0<TT> list) {
      this.list = list;
      node = list.first;
    }
